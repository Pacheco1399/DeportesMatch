        ...
        <div class="container-fluid"> 
            <body>
                ...
                <div class="container md">
                    ...
                    <br>
                    <h4>¿Para que me sirve crear un Torneo? </h4>
                ...
                <div class="card body">
                    <h5>Administrar tus torneos
                        <a class="btn btn-success mb-3" href="{{ route('torneos.lista') }}">Administrar</a>
                    </h5>
                    <h5>Crear un nuevo Torneo
                        <a class="btn btn-success mb-3" href="{{ route('torneos.crear') }}">Crear</a>
                    </h5>
