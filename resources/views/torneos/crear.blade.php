...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-/bQdsTh/da6pkI1MST/rWKFNjaCP5gBSY4sEBT38Q/9RBh9AH40zEOg7Hlq2THRZ" crossorigin="anonymous"></script>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Crear torneo') }}</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('torneos.almacen') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 my-2" >
                                    <input id="fecha" type="date" class="form-control @error('fecha') is-invalid @enderror "
                                        name="fecha" value="<?php echo $today; ?>"  required autocomplete="fecha">
                            ...
                            <div class="form-group row">
                                <label for="tipo_torneo"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Tipo de torneo') }}</label>

                                    <div class="col-md-6 my-2">
                                        <select id="cantidad_equipos" type="number" class="form-control "  
                                            name="tipo_torneo" value="{{ old('tipo_torneo') }}" required autocomplete="tipo_torneo"  autofocus>
                                            <option selected value="0">Torneo por grupos </option>
                                            <option selected value="1">Torneo por Eliminacion </option>
                                        </select>
                                    </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="cantidad_equipos"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Cantidad de equipos participantes') }}</label>

                                    <div class="col-md-6 my-2">
                                        <input id="cantidad_equipos" type="number" class="form-control @error('cantidad_equipos') is-invalid @enderror "
                                        name="cantidad_equipos" required autocomplete="cantidad_equipos" min="4" max="30">
