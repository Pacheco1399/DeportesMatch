                              ...
                              <div>
                                  <ul >
                                      ...
                                      @if ($points->posicion == 2)
                                        ...
                                        <a class="bi bi-pencil-square" href="{{ route('torneos.mover.puesto', ['posicion' => $points->posicion]) }}"></a>
                                  ...
                                  <ul>
                                      <li ondrop="drop(event)" ondragover="allowDrop(event)"  name= "3" id = "3">
                                        ...
                                        @if ($points->posicion == 3)
                                          <input value="{{ $points->nombreEquipo }}" draggable="true" ondragstart="drag(event)" id="{{$points->posicion}}" width="88" height="31" readonly>
                                          <a class="bi bi-pencil-square" href="{{ route('torneos.mover.puesto', ['posicion' => $points->id]) }}"></a>
                                          @endif
                                        @endforeach
                                      </li>
                                              ...
                                              @foreach ($puntuacion as $point)
                                                  ...
                                                  @if ($i <= 8)
                                                      ...
                                                      <td>
                                                        ...
                                                        <a class="bi bi-pencil-square" href="{{ route('torneos.puntosportorneo', ['posicion' => $point->id]) }}"></a>
                                                      </td>
